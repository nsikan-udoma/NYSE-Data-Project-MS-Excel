...
The dataset provided only had data about the total revenue generated, the amounts spent on cost to generate the revenue, and the operating profit before deduction of income taxes and interest payments. Hence there were limitations on what type of deep dive analysis could be done to generate in-depth insights and draw conclusions.
